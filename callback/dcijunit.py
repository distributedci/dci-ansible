...
class TestCase:
    ...
    def __init__(self, name: str, assertions: Optional[int] = None, classname: Optional[str] = None,
                 status: Optional[str] = None, time: Optional[decimal.Decimal] = None,
                 errors: Optional[List['TestError']] = None, failures: Optional[List['TestFailure']] = None,
                 skipped: Optional[str] = None, system_out: Optional[str] = None,
                 system_err: Optional[str] = None, is_disabled: bool = False):
        self.name = name
...
class TestSuite:
    ...
    def __init__(self, name: str, hostname: Optional[str] = None, id: Optional[str] = None,
                 package: Optional[str] = None, timestamp: Optional[datetime.datetime] = None,
                 properties: Optional[Dict[str, str]] = None, cases: Optional[List['TestCase']] = None,
                 system_out: Optional[str] = None, system_err: Optional[str] = None):
        self.name = name
...
class CallbackModule(CallbackBase):
    ...
    This plugin makes use of the following environment variables:
        ...
        JUNIT_HIDE_TASK_ARGUMENTS (optional): Hide the arguments for a task
                                     Default: False
        JUNIT_TEST_CASE_PREFIX (optional): Consider a task only as test case if it matches this regular expression.
                                     test cases.
                                     Default: <empty>
    """
    ...
    def __init__(self):
        ...
        self._test_case_regex = None if self._test_case_prefix == '' else re.compile(self._test_case_prefix, re.IGNORECASE)
    ...
    def _finish_task(self, status, result):
        ...
        if self._test_case_regex and self._test_case_regex.search(task_data.name):
